...
export default {
 ...
 async mounted(){
var $vm=this;
await $vm.$store.dispatch("getGuiQasFormOne",$vm.gui)

$vm.gui=$vm.$store.state.interplex.qas_form_one_ui;
 },
 methods:{
    async reset(){
var $vm=this;
$vm.gui=reset.dataset.qas_form_one_ui;
await $vm.$store.dispatch("setGuiQasFormOne",$vm.gui)
$vm.$alert("Reset")
