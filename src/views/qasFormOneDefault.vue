    ...
    <v-icon>fa-plus</v-icon>
                    ...
                    <div style="display:flex;">
                        ...
                        >
                              ...
                              <v-btn  color="primary" style="margin:10px" @click="productSettingDialog = true" outlined>
...
{{isKeyExist(form[item.name],'merge')}} -->
                                           ...
                                           <!-- {{form.column[index_sub].name}} -->
                                            ...
                                            <v-combobox
                                                    ...
                                                    hide-selected
                                                    small-chips
                                                    :messages="form.column[index_sub].name+' Dataset For'"
                                        ...
                                        <div v-else>
                                            ...
                                            >
                                                ...
                                                <v-combobox
                                                    ...
                                                    hide-selected
                                                    small-chips
                                                    :messages="Object.keys(form)[index_sub]+' Dataset For'"
                                                ></v-combobox>
...
// ------------------qasformone----------
var payload={
observation_header_print_view:$vm.insertForm.observation_header_print_view,    
observation_format:$vm.insertForm.observation_format,
observation_print_view:$vm.insertForm.observation_print_view
}

await $vm.$store.dispatch('setQasFormOneDefault',payload)
$vm.$alert("Saved")
// var payload={
...
// ------------------qasformone----------
var payload={
observation_header_print_view:reset.dataset.observation_header_print_view_format,    
observation_format:reset.dataset.configProductsFormat,
observation_print_view:reset.dataset.observation_print_view_format,
}
